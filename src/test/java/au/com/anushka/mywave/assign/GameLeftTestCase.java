...
public class GameLeftTestCase {
    ...
    @Test
    public void test_In_Valid_Left_Without_Place_Test() throws Exception{

        final Boolean leftValid = game.left();

        assertFalse("In Valid Left", leftValid);
    ...
    @Test
    public void test_Valid_Left_After_SOUTH_Test() throws Exception{
        ...
        assertTrue("Valid Left", leftValid);
        assertEquals("Unchanged X", game.getRobot().getLocationX(), new Integer(3));
        assertEquals("Unchanged Y", game.getRobot().getLocationY(), new Integer(2));
    ...
    @Test
    public void test_Valid_Left_After_EAST_Test() throws Exception{
    ...
    @Test
    public void test_Valid_Left_After_NORTH_Test() throws Exception{
    ...
    @Test
    public void test_Valid_Left_After_WEST_Test() throws Exception{
